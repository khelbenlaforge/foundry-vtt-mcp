...
const ALLOWED_SPELL_SCHOOLS = ['abj', 'con', 'div', 'enc', 'evo', 'ill', 'nec', 'trs'];
const ALLOWED_DURATION_UNITS = ['inst', 'turn', 'round', 'minute', 'hour', 'day', 'month', 'year', 'spec', 'perm'];
const ALLOWED_RANGE_UNITS = ['self', 'touch', 'ft', 'mi', 'spec'];
// dnd5e CONFIG.DND5E.itemProperties keys valid for spells — V/S/M/C/R
const ALLOWED_SPELL_COMPONENTS = ['vocal', 'somatic', 'material', 'concentration', 'ritual'];

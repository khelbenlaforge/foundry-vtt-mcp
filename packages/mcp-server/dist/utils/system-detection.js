 ...
 */
export async function detectGameSystem(foundryClient, logger) {
    if (cachedSystem) {
        return cachedSystem;
    }
    try {
 ...
 */
export function getCachedSystemId() {
 ...
 */
export function getSystemPaths(system) {
    if (system === 'dnd5e') {
 ...
 */
export function extractSystemValue(data, path) {
    if (!path || !data) {
        return undefined;
    }
 ...
 */
export function getCreatureLevel(actorData, system) {
 ...
 */
export function getCreatureType(actorData, system) {
    if (system === 'dnd5e') {
 ...
 */
export function hasSpellcasting(actorData, system) {
    if (system === 'dnd5e') {
 ...
 */
export function formatSystemError(system, systemId) {
    if (system === 'other') {

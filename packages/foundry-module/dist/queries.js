...
export class QueryHandlers {
    ...
    async handleSetActorToken(data) {
        try {
            const gmCheck = this.validateGMAccess();
            if (!gmCheck.allowed)
                return { error: 'Access denied', success: false };
    ...
    async handleRefreshActorFromSource(data) {
        try {
            const gmCheck = this.validateGMAccess();
            if (!gmCheck.allowed)
                return { error: 'Access denied', success: false };
            ...
            throw new Error(`Failed to refresh actor from compendium source: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    ...
    async handleRestoreScenes(data) {
        try {
            const gmCheck = this.validateGMAccess();
            if (!gmCheck.allowed) {
                return { error: 'Access denied', success: false };
    ...
    async handleAddSaveFeatureToActor(data) {
        try {
            const gmCheck = this.validateGMAccess();
            if (!gmCheck.allowed) {
                return { error: 'Access denied', success: false };
    ...
    async handleCreateNpcActor(data) {
        try {
            const gmCheck = this.validateGMAccess();
            if (!gmCheck.allowed) {
                return { error: 'Access denied', success: false };
    ...
    async handleAddAttackToActor(data) {
        try {
            const gmCheck = this.validateGMAccess();
            if (!gmCheck.allowed) {
                return { error: 'Access denied', success: false };
    ...
    async handleAddAuraToActor(data) {
        try {
            const gmCheck = this.validateGMAccess();
            if (!gmCheck.allowed) {
                return { error: 'Access denied', success: false };
    ...
    async handleAddSummonActivityToActor(data) {
        try {
            const gmCheck = this.validateGMAccess();
            if (!gmCheck.allowed) {
                return { error: 'Access denied', success: false };
            ...
            throw new Error(`Failed to add summon activity to actor: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    async handleAddPassiveFeatureToActor(data) {
        try {
            const gmCheck = this.validateGMAccess();
            if (!gmCheck.allowed) {
                return { error: 'Access denied', success: false };
    ...
    async handleAddAttackWithSaveToActor(data) {
        try {
            const gmCheck = this.validateGMAccess();
            if (!gmCheck.allowed) {
                return { error: 'Access denied', success: false };
            ...
            if (!data.saveAbility)
                throw new Error('saveAbility is required');
            if (!data.saveDC)
                throw new Error('saveDC is required');
    ...
    async handleSetActorSpellcasting(data) {
        try {
            const gmCheck = this.validateGMAccess();
            if (!gmCheck.allowed) {
                return { error: 'Access denied', success: false };
            ...
            if (typeof data.spellcastingLevel !== 'number' ||
    ...
    async handleAddSpellsToActor(data) {
        try {
            const gmCheck = this.validateGMAccess();
            if (!gmCheck.allowed) {
                return { error: 'Access denied', success: false };

 ...
 */
export function getExperienceLevel(totalAP) {
 ...
 */
export function getExperienceLevelByNumber(level) {
 ...
 */
export const SIZE_MAP_DE_TO_EN = {
    'winzig': 'tiny',
    'klein': 'small',
    'mittel': 'medium',
 ...
 */
export const SIZE_MAP_EN_TO_DE = {
    'tiny': 'Winzig',
    'small': 'Klein',
    'medium': 'Mittel',
    'average': 'Mittel',

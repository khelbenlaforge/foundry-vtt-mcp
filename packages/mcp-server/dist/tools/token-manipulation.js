...
export class TokenManipulationTools {
    ...
    async handleGetTokenDetails(args) {
        const schema = z.object({
            tokenId: z.string(),
        });
    ...
    async handleToggleTokenCondition(args) {
        const schema = z.object({
            tokenId: z.string(),
    ...
    async handleGetAvailableConditions(args) {
...
//# sourceMappingURL=token-manipulation.js.map
...
export class MacInstaller {
     ...
     */
    async downloadComfyUI(downloadPath) {
        this.updateProgress({
        ...
        try {
            ...
            throw new Error(`Failed to download ComfyUI Desktop: ${message}\n\n` +
     ...
     */
    async installComfyUI(archivePath) {
        this.updateProgress({
     ...
     */
    async downloadFile(url, destPath, displayName, modelSize) {
...
//# sourceMappingURL=mac-installer.js.map
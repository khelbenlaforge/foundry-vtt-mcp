export class ErrorHandler {
     ...
     */
    formatErrorMessage(mcpError, toolName) {
     ...
     */
    logError(mcpError, toolName, originalError) {
        const logData = {
            toolName,
     ...
     */
    handleToolError(error, toolName, context = '') {
     ...
     */
    createValidationError(message, suggestions = []) {
        return {
            type: 'validation',
            message,
            suggestions: [
     ...
     */
    createPermissionError(operation, setting) {
        const suggestions = [
